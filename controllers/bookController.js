...
exports.book_create_post = [
  ...
  body("title")
    ...
    .isAlphanumeric()
    .withMessage("Only alphanumeric characters are allowed for Title"),

  body("summary")
    .isLength({ min: 1 })
    .trim()
    .withMessage("Summary field is required")
    .isAlphanumeric()
    .withMessage("Only alphanumeric characters are allowed for Summary"),
  ...
  body("isbn")
    ...
    .isAlphanumeric()
    .withMessage("Only alphanumeric characters are allowed for ISBN"),
